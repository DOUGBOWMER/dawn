"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["vendors-node_modules_thirdweb-dev_sdk_dist_marketplacev3-7d2d5b47_esm_js"],{
...
/* harmony import */ var _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__(/*! ./thirdweb-checkout-2c8d478b.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/thirdweb-checkout-2c8d478b.esm.js");
...
const DirectListingInputParamsSchema = zod__WEBPACK_IMPORTED_MODULE_66__.z.object({
   ...
   */
  assetContractAddress: _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.af,
  /**
   * The ID of the token to list.
   */
  tokenId: _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ad,
  /**
   * The quantity of tokens to include in the listing.
   *
   * For ERC721s, this value should always be 1 (and will be forced internally regardless of what is passed here).
   */
  quantity: _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ad["default"](1),
  /**
   * The address of the currency to accept for the listing.
   */
  currencyContractAddress: _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.af["default"](_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ce),
  /**
   ...
   */
  startTimestamp: _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ag["default"](new Date()),
  /**
   * The end time of the listing.
   */
  endTimestamp: _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ai,
  /**
...
class MarketplaceV3DirectListings {
  ...
  constructor(contractWrapper, storage) {
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "featureName", _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cS.name);
    ...
    this.events = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.aX(this.contractWrapper);
    this.encoder = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.al(this.contractWrapper);
    this.interceptor = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.aY(this.contractWrapper);
    this.estimator = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.aW(this.contractWrapper);
  }
  getAddress() {
  ...
  async getAll(filter) {
    ...
    let rawListings = [];
    let batches = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cT)(start, end, this.contractWrapper.readContract.getAllListings);
  ...
  async getAllValid(filter) {
    ...
    let rawListings = [];
    let batches = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cT)(start, end, this.contractWrapper.readContract.getAllValidListings);
    rawListings = batches.flat();
    const filteredListings = this.applyFilter(rawListings, filter);
    return await Promise.all(filteredListings.map(listing => this.mapListing(listing)));
  }
  ...
  async createListing(listing) {
    ...
    await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cU)(this.contractWrapper, this.getAddress(), parsedListing.assetContractAddress, parsedListing.tokenId, await this.contractWrapper.getSignerAddress());
    const normalizedPricePerToken = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ba)(this.contractWrapper.getProvider(), parsedListing.pricePerToken, parsedListing.currencyContractAddress);
    ...
    const receipt = await this.contractWrapper.sendTransaction("createListing", [{
      ...
      currency: (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cV)(parsedListing.currencyContractAddress),
  ...
  async buyFromListing(listingId, quantityDesired, receiver) {
    ...
    await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cW)(this.contractWrapper, value, listing.currencyContractAddress, overrides);
    return {
  ...
  async mapListing(listing) {
    let status = _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.UNSET;
    const block = await this.contractWrapper.getProvider().getBlock("latest");
    const blockTime = block.timestamp;
    switch (listing.status) {
      case 1:
        status = ethers__WEBPACK_IMPORTED_MODULE_69__.BigNumber.from(listing.startTimestamp).gt(blockTime) ? _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Created : ethers__WEBPACK_IMPORTED_MODULE_69__.BigNumber.from(listing.endTimestamp).lt(blockTime) ? _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Expired : _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Active;
        break;
      case 2:
        status = _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Completed;
        break;
      case 3:
        status = _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Cancelled;
        break;
    }
    return {
      ...
      currencyValuePerToken: await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b8)(this.contractWrapper.getProvider(), listing.currency, listing.pricePerToken),
      id: listing.listingId.toString(),
      tokenId: listing.tokenId.toString(),
      quantity: listing.quantity.toString(),
      startTimeInSeconds: ethers__WEBPACK_IMPORTED_MODULE_69__.BigNumber.from(listing.startTimestamp).toNumber(),
      asset: await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cX)(listing.assetContract, this.contractWrapper.getProvider(), listing.tokenId, this.storage),
  ...
  async isStillValidListing(listing, quantity) {
    const approved = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cY)(this.contractWrapper.getProvider(), this.getAddress(), listing.assetContractAddress, listing.tokenId, listing.creatorAddress);
    if (!approved) {
      return {
        valid: false,
    ...
    const isERC721 = await erc165.supportsInterface(_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cc);
    const isERC1155 = await erc165.supportsInterface(_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cd);
    if (isERC721) {
...
const EnglishAuctionInputParamsSchema = zod__WEBPACK_IMPORTED_MODULE_66__.z.object({
   ...
   */
  timeBufferInSeconds: _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ad["default"](900),
   ...
   */
  bidBufferBps: _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ad["default"](500),
  // 5% by default
...
class MarketplaceV3EnglishAuctions {
  ...
  constructor(contractWrapper, storage) {
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "featureName", _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cZ.name);
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "contractWrapper", void 0);
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "storage", void 0);
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "events", void 0);
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "interceptor", void 0);
  ...
  async getAll(filter) {
    ...
    let rawAuctions = [];
    let batches = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cT)(start, end, this.contractWrapper.readContract.getAllAuctions);
  ...
  async getAllValid(filter) {
    ...
    let rawAuctions = [];
    let batches = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cT)(start, end, this.contractWrapper.readContract.getAllValidAuctions);
    rawAuctions = batches.flat();
    const filteredAuctions = this.applyFilter(rawAuctions, filter);
    return await Promise.all(filteredAuctions.map(auction => this.mapAuction(auction)));
  }
  ...
  async createAuction(auction) {
    ...
    await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cU)(this.contractWrapper, this.getAddress(), parsedAuction.assetContractAddress, parsedAuction.tokenId, await this.contractWrapper.getSignerAddress());
    const normalizedBuyoutAmount = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ba)(this.contractWrapper.getProvider(), parsedAuction.buyoutBidAmount, parsedAuction.currencyContractAddress);
    const normalizedMinBidAmount = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ba)(this.contractWrapper.getProvider(), parsedAuction.minimumBidAmount, parsedAuction.currencyContractAddress);
    const block = await this.contractWrapper.getProvider().getBlock("latest");
    const blockTime = block.timestamp;
    ...
    const receipt = await this.contractWrapper.sendTransaction("createAuction", [{
      ...
      currency: (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cV)(parsedAuction.currencyContractAddress),
  ...
  async buyoutAuction(auctionId) {
    const auction = await this.validateAuction(ethers__WEBPACK_IMPORTED_MODULE_69__.BigNumber.from(auctionId));
    const currencyMetadata = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b9)(this.contractWrapper.getProvider(), auction.currencyContractAddress);
  ...
  async makeBid(auctionId, bidAmount) {
    const auction = await this.validateAuction(ethers__WEBPACK_IMPORTED_MODULE_69__.BigNumber.from(auctionId));
    const normalizedBidAmount = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ba)(this.contractWrapper.getProvider(), bidAmount, auction.currencyContractAddress);
    ...
    const overrides = (await this.contractWrapper.getCallOverrides()) || {};
    await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cW)(this.contractWrapper, normalizedBidAmount, auction.currencyContractAddress, overrides);
    return {
  ...
  async closeAuctionForBidder(auctionId, closeFor) {
    ...
    try {
      ...
      if (err.message.includes("Marketplace: auction still active.")) {
        throw new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.bv(auctionId.toString(), auction.endTimeInSeconds.toString());
      } else {
        throw err;
      }
    }
  ...
  async getMinimumNextBid(auctionId) {
    ...
    return (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b8)(this.contractWrapper.getProvider(), auction.currencyContractAddress, minimumNextBid);
  }
  ...
  async mapAuction(auction) {
    ...
    switch (auction.status) {
      case 1:
        status = ethers__WEBPACK_IMPORTED_MODULE_69__.BigNumber.from(auction.startTimestamp).gt(blockTime) ? _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Created : ethers__WEBPACK_IMPORTED_MODULE_69__.BigNumber.from(auction.endTimestamp).lt(blockTime) ? _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Expired : _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Active;
        break;
      case 2:
        status = _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Completed;
        break;
    ...
    return {
      ...
      minimumBidCurrencyValue: await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b8)(this.contractWrapper.getProvider(), auction.currency, auction.minimumBidAmount),
      buyoutBidAmount: auction.buyoutBidAmount.toString(),
      buyoutCurrencyValue: await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b8)(this.contractWrapper.getProvider(), auction.currency, auction.buyoutBidAmount),
      ...
      asset: await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cX)(auction.assetContract, this.contractWrapper.getProvider(), auction.tokenId, this.storage),
      status: status
    };
  }
  ...
  async mapBid(auctionId, bidderAddress, currencyContractAddress, bidAmount) {
    return {
      ...
      bidAmount,
      bidAmountCurrencyValue: await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b8)(this.contractWrapper.getProvider(), currencyContractAddress, bidAmount)
    };
  }
...
class MarketplaceV3Offers {
  ...
  constructor(contractWrapper, storage) {
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "featureName", _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.c_.name);
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "contractWrapper", void 0);
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "storage", void 0);
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "events", void 0);
    (0,_QueryParams_da88d27c_esm_js__WEBPACK_IMPORTED_MODULE_68__._)(this, "interceptor", void 0);
  ...
  async getAll(filter) {
    ...
    let rawOffers = [];
    let batches = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cT)(start, end, this.contractWrapper.readContract.getAllOffers);
  ...
  async getAllValid(filter) {
    ...
    let rawOffers = [];
    let batches = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cT)(start, end, this.contractWrapper.readContract.getAllValidOffers);
    rawOffers = batches.flat();
    const filteredOffers = this.applyFilter(rawOffers, filter);
    return await Promise.all(filteredOffers.map(offer => this.mapOffer(offer)));
  }
  ...
  async makeOffer(offer) {
    ...
    const currency = (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cR)(parsedOffer.currencyContractAddress) ? _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cf[chainId].wrapped.address : parsedOffer.currencyContractAddress;
    const normalizedTotalPrice = await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.ba)(this.contractWrapper.getProvider(), parsedOffer.totalPrice, currency);
    const overrides = await this.contractWrapper.getCallOverrides();
    await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cW)(this.contractWrapper, normalizedTotalPrice, currency, overrides);
  ...
  async acceptOffer(offerId) {
    ...
    const overrides = (await this.contractWrapper.getCallOverrides()) || {};
    await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cU)(this.contractWrapper, this.getAddress(), offer.assetContractAddress, offer.tokenId, await this.contractWrapper.getSignerAddress());
    return {
  ...
  async mapOffer(offer) {
    ...
    switch (offer.status) {
      case 1:
        status = ethers__WEBPACK_IMPORTED_MODULE_69__.BigNumber.from(offer.expirationTimestamp).lt(blockTime) ? _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Expired : _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Active;
        break;
      case 2:
        status = _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b4.Completed;
        break;
    ...
    return {
      ...
      currencyValue: await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b8)(this.contractWrapper.getProvider(), offer.currency, offer.totalPrice),
      asset: await (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cX)(offer.assetContract, this.contractWrapper.getProvider(), offer.tokenId, this.storage),
  ...
  async isStillValidOffer(offer) {
    ...
    const chainId = await this.contractWrapper.getChainID();
    const currency = (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cR)(offer.currencyContractAddress) ? _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cf[chainId].wrapped.address : offer.currencyContractAddress;
    const provider = this.contractWrapper.getProvider();
    const erc20 = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cM(provider, currency, _thirdweb_dev_contracts_js_dist_abis_IERC20_json__WEBPACK_IMPORTED_MODULE_4__, {});
...
class MarketplaceV3 {
   ...
   */
  get directListings() {
    return (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.bZ)(this.detectDirectListings(), _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cS);
  }
  /**
   * Auctions
   ...
   */
  get englishAuctions() {
    return (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.bZ)(this.detectEnglishAuctions(), _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cZ);
  }
   ...
   */
  get offers() {
    return (0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.bZ)(this.detectOffers(), _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.c_);
  }
  get chainId() {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cM(network, address, abi, options);
    ...
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.metadata = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.am(this.contractWrapper, _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.cP, this.storage);
    this.roles = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.an(this.contractWrapper, MarketplaceV3.contractRoles);
    this.encoder = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.al(this.contractWrapper);
    this.estimator = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.aW(this.contractWrapper);
    this.events = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.aX(this.contractWrapper);
    this.platformFees = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.aZ(this.contractWrapper);
    this.interceptor = new _thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.aY(this.contractWrapper);
  }
  ...
  detectDirectListings() {
    if ((0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b_)(this.contractWrapper, "DirectListings")) {
      return new MarketplaceV3DirectListings(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectEnglishAuctions() {
    if ((0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b_)(this.contractWrapper, "EnglishAuctions")) {
      return new MarketplaceV3EnglishAuctions(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectOffers() {
    if ((0,_thirdweb_checkout_2c8d478b_esm_js__WEBPACK_IMPORTED_MODULE_67__.b_)(this.contractWrapper, "Offers")) {
